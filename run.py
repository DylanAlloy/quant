...
# Option parameters
sigma = 1.00        # Flat volatility
strike = 415      # Fixed strike
epsilon = 0.4       # The % on the left/right of Strike. 
                    # Asset prices are centered around Spot ("ATM Spot")
shortexpiry = 1    # Shortest expiry in days
longexpiry = 60    # Longest expiry in days
riskfree = 0.00     # Continuous risk free rate
divrate = 1.69      # Continuous div rate

# Grid definition
dx, dy = 100, 100     # Steps throughout asset price and expiries axis
...
zz = np.array([BSMerton([1,x,strike,riskfree,divrate,y,sigma]).Charm for
